...
<html style="padding-left: 100px; padding-right: 100px;">
    ...
    <body>
        <section class="content">
            <h5 class="text-black h4 title-cadastro">Excluir - Excluir Agendamento de Clientes</h5>
            <p class="p-cadastro">Sistema utilizado para excluir agendamentos de serviços.</p>
            <!-- FORM -->
            <form>
                <!--Nome-->
                <div class="mb-3">
