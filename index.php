        ...
        <section class="content">
            ...
            <form method="post" action="controller/ControllerCadastro.php?funcao=cadastro" id="form" name="form">
                ...
                <div class="mb-3">
                    ...
                    <input name="txtNome" type="text" class="form-control" required id="txtNome" placeholder="Nome Completo">
                </div>
                <!--Telefone-->
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Telefone</label>
                    <input required name="txtTelefone" type="text" class="form-control" id="txtTelefone" placeholder="(xx)xxxxx-xxxx">
                </div>
                <!--Origem-->
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Origem</label>
                    <select required name="txtOrigem" id="txtOrigem" class="form-select">
                ...
                <div class="mb-3">
                    ...
                    <input required name="txtDataContato" type="date" class="form-control" id="txtDataContato">
                </div>
                <!--Observação-->
                <div class="mb-3">
